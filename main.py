...
def main():
    ...
    # 3 Options: Video, WebCam, Auto Classify
    ...
    if options == 'Video':
        ...
        if not video_file_buffer:
            if exercise_options == "Bicept Curl":
                DEMO_VIDEO = 'video_demo/bicept_curl.mp4'
            elif exercise_options == "Push Up":
                DEMO_VIDEO = "video_demo/push_up.mp4"
            elif exercise_options == "Shoulder Press":
                DEMO_VIDEO = "video_demo/shoulder_press.mp4"
            elif exercise_options == "Squat":
                DEMO_VIDEO = "video_demo/squat.mp4"
